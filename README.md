### Hi there, I'm Sami Ullah Khan! 👋

**Android & Kotlin Developer | AI Enthusiast | Vibe Coder**
...
* **Workflow:** Command Line (CLI), Git
* **Certifications:** Google AI Professional Certificate (Coursera)

### 🚀 Featured Projects
* 🧠 **AI-Powered Smart Notes:** An intelligent note-taking application featuring an emotion/mood-based UI and Gemini AI summarization.
* 🏫 **BLS School LMS:** A comprehensive Learning Management System with an automated admission record and communication engine.
* 📥 **sami-downloader:** A fast and efficient video downloading utility application.
